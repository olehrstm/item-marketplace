...
public class BlackMarketMenu extends PaginatedMenu<Offer> {
    ...
    public PaginatedMenuContext<Offer> getMenu(Player player) {
        return PaginatedMenuContext.<Offer>paginated()
                .menuId("black_market")
                .iterable(this.marketplaceService.getOffers().stream().filter(offer -> offer.getType() == BLACK_MARKET)
                ...
                .itemProvider(offer -> {
                    ...
                    return MenuItem.builder()
                            ...
                            .function(click -> {
                                ...
                                new ConfirmMenu(this, this.marketplaceService, offer).open(player);
                            })
                            .build();
                })
                .itemId("1")
